...
public class SpringDocConfiguration__TestContext001_BeanDefinitions {
   ...
   */
  private static BeanInstanceSupplier<StandardReflectionParameterNameDiscoverer> getLocalSpringDocParameterNameDiscovererInstanceSupplier(
      ) {
    return BeanInstanceSupplier.<StandardReflectionParameterNameDiscoverer>forFactoryMethod(SpringDocConfiguration.class, "localSpringDocParameterNameDiscoverer")
  ...
  public static BeanDefinition getLocalSpringDocParameterNameDiscovererBeanDefinition() {
    ...
    beanDefinition.setTargetType(StandardReflectionParameterNameDiscoverer.class);
    beanDefinition.setLazyInit(false);
