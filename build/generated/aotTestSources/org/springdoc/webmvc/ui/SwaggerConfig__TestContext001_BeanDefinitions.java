...
public class SwaggerConfig__TestContext001_BeanDefinitions {
  ...
  private static BeanInstanceSupplier<SwaggerWebMvcConfigurer> getSwaggerWebMvcConfigurerInstanceSupplier(
    ...
    return BeanInstanceSupplier.<SwaggerWebMvcConfigurer>forFactoryMethod(SwaggerConfig.class, "swaggerWebMvcConfigurer", SwaggerUiConfigParameters.class, SwaggerIndexTransformer.class, Optional.class)
            .withGenerator((registeredBean, args) -> registeredBean.getBeanFactory().getBean(SwaggerConfig.class).swaggerWebMvcConfigurer(args.get(0), args.get(1), args.get(2)));
  }
