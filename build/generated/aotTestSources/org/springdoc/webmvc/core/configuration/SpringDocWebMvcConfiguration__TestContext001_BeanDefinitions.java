...
public class SpringDocWebMvcConfiguration__TestContext001_BeanDefinitions {
  ...
  private static BeanInstanceSupplier<OpenApiWebMvcResource> getOpenApiResourceInstanceSupplier() {
    return BeanInstanceSupplier.<OpenApiWebMvcResource>forFactoryMethod(SpringDocWebMvcConfiguration.class, "openApiResource", ObjectFactory.class, AbstractRequestService.class, GenericResponseService.class, OperationService.class, SpringDocConfigProperties.class, Optional.class, Optional.class, Optional.class, Optional.class, SpringDocProviders.class)
            .withGenerator((registeredBean, args) -> registeredBean.getBeanFactory().getBean(SpringDocWebMvcConfiguration.class).openApiResource(args.get(0), args.get(1), args.get(2), args.get(3), args.get(4), args.get(5), args.get(6), args.get(7), args.get(8), args.get(9)));
  }
  ...
  private static BeanInstanceSupplier<RequestService> getRequestBuilderInstanceSupplier() {
    return BeanInstanceSupplier.<RequestService>forFactoryMethod(SpringDocWebMvcConfiguration.class, "requestBuilder", GenericParameterService.class, RequestBodyService.class, OperationService.class, Optional.class, StandardReflectionParameterNameDiscoverer.class)
