...
import com.empikproject.EmpikProjectApplicationTests__TestContext001_ApplicationContextInitializer;
...
public class AotTestContextInitializers__Generated {
  public static Map<String, Supplier<ApplicationContextInitializer<? extends ConfigurableApplicationContext>>> getContextInitializers(
    ...
    map.put("com.empikproject.EmpikProjectApplicationTests", () -> new EmpikProjectApplicationTests__TestContext001_ApplicationContextInitializer());
    return map;
  }
  ...
  public static Map<String, Class<? extends ApplicationContextInitializer<?>>> getContextInitializerClasses(
    ...
    map.put("com.empikproject.EmpikProjectApplicationTests", EmpikProjectApplicationTests__TestContext001_ApplicationContextInitializer.class);
    return map;
  }
}
